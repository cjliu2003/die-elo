...
CREATE TABLE MATCH (
    ...
    winning_team_score INT NOT NULL CHECK (winning_team_score >= 12 AND winning_team_score > losing_team_score),
    losing_team_score INT NOT NULL CHECK (losing_team_score >= 0 AND winning_team_score > losing_team_score)
);
